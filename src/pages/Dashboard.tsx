...
import { getBirthdayCountdown } from "@/lib/birthdayCountdown";
            ...
            <div>
              ...
              <p className="mt-2 text-sm text-muted-foreground">
                {countdown.arrived
                  ...
                  : `Target locked for ${countdown.targetLabel} in Dublin time — launch the day with photos, food, and games.`}
              </p>
            </div>
